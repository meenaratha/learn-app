...
@section('title')
<title>Unitelearning || Online class Training Course 2</title>
@endsection
@section('body')
<!--Online class Training Course 2 body content start-->
        <!-- Page title -->
                        ...
                        <div class="page-title-heading">
                            <div class="breadcrumbs">
                                <ul class="trail-items">
                                    ...
                                    <li class="trail-end">Case Studies Layout 02</li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    <div class="flat-wrapper">
                        <div class="flat-portfolio portfolio-masonry">
                            ...
                            <div class="portfolio">
                                <div class="portfolio-item item-three-column coaching consulting">
                                ...
                                <div class="portfolio-item item-three-column coaching">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                ...
                                <div class="portfolio-item item-three-column assessment">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                ...
                                <div class="portfolio-item item-three-column messaging">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
                                ...
                                <div class="portfolio-item item-three-column consulting">
                                    <div class="portfolio-wrap">
                                        <div class="portfolio-thumbnail">
