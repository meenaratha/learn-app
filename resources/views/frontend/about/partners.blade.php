...
@section('title')
<title>Unitelearning || Partners</title>
@endsection
@section('body')
                        ...
                        <div class="page-title-heading">
                            <div class="breadcrumbs">
                                <ul class="trail-items">
                                    ...
                                    <li class="trail-end"> Our Partners </li>
                                </ul>
                            </div>
                    ...
                    <div class="flat-wrapper">
                        <div class="general flat-clients">
                            <div class="general-text">
                                ...
                                <p>Our deep knowledge and experience across a multitude of industries allows us to provide unique and valuable insight and counsel to our partners/clients.</p>
                                <p>Unitelearning has provided services in 50 countries and in 20 languages. We can help your entire global sales organization overcome business development challenges and go-to-market successfully. While some of the world’s largest companies are our partners/clients, we’ve helped grow businesses of every size—from emerging startups to the Global 2000 and Fortune 500.</p>
                            ...
                            <div class="clients-text-title">
                                <h6>IF YOU WOULD LIKE TO DISCUSS A POTENTIAL PARTNERSHIP
                                    WITH UNITELEARNING, PLEASE CONTACT US AT TEL:
                                    1800 232 3485 OR INFO@UNITELEARNING.COM</h6>
                            </div>
                        </div><!-- /.flat-clients -->
                                ...
                                <div class="sidebar">
                                    <div class="widget widget_nav_menu">
                                        <ul class="nav_menu">
                                            ...
                                            <li class="menu-item">
                                                <a class="active" href="{{route('partners')}}">Partners </a>
                                            </li>
                                            <li class="menu-item">
                                    ...
                                    @include('frontend.layout.download')<!-- /.widget_text -->
                                </div><!-- /.sidebar -->
                            </div><!-- /.sidebar-wrap -->
                        </div><!-- /.general-sidebar -->
                    </div><!-- /.flat-wrapper -->
